...
@section('content')
    ...
    <div class="flex flex-col w-full px-10 mb-10">
        <x-card-head>
           Demande de prêts
            <x-slot name="action">
                <a href="{{route('gp.demande.tmp.index')}}" class="mr-4 hover:text-orange-500">
                ...
                <a id="btnDelete" href="#" class="mr-4 hover:text-orange-500">
        ...
        <div class="flex flex-col mb-10">
            @foreach ($demandes as $demande)
                <div class="flex">
                    <a href="{{route('gp.demande.tmp.edit', App\Lib\CryptId::crypt($demande->id_demande))}}"
        ...
        @if($dossier->statut == 'O')
            <div class="flex justify-center space-x-5">
                ...
                <a href="{{route('gp.demande.tmp.membre', $dossier->id_dossier)}}" class="btn btn-warning-alt">
    ...
    <form id="frmDemande"  method="post" action="{{route('gp.demande.tmp.destroy', $dossier->id_dossier)}}">
        @csrf
    ...
    <x-msg-box>
        ...
        Voulez vous réellement supprimer cette demande ?
    </x-msg-box>
@endsection
