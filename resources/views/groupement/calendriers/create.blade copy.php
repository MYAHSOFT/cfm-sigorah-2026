    ...
    <div class="flex flex-col w-full px-10 mb-10">
        ...
        @if(!empty($calendriers))
            <div class="flex justify-center">
                ...
                <form id="frmCalendrier" method="post" action="{{route('gp.calendrier.store')}}">
                    @csrf
                    <input type="hidden" name="dossier" value="{{$groupe->id_dossier}}">
                </form>

                <div>
                    <button class="btn btn-warning-alt msg-box-show">
