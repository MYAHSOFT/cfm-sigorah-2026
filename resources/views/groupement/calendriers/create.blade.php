...
@section('content')
    ...
    <div class="flex flex-col w-full px-10 mb-10">
        <x-card-head>
           Calendrier
            <x-slot name="action">
                ...
                <a href="{{route('gp.calendrier.edit', $dossier->id_dossier)}}" class="text-gray-400 hover:text-orange-500">
        ...
        <div class="flex flex-col w-full mb-10 space-y-5 bg-gray-300 bg-opacity-40 py-4 px-3 rounded-lg">
            ...
            <div class="mt-10">
                <x-alert/>
                <form id="frmCalendrier" method="post" action="{{ $url }}">
                    @csrf
        ...
        @if(count($calendriers) > 0)
            <div class="flex flex-col mb-10 mt-5">
            ...
            <div class="flex justify-center mt-3">
                <button id="btnCalendrier" class="btn btn-warning msg-box-show">
...
@section('script')
    ...
    <script>
        ...
        document.getElementById("btnCalendrier").addEventListener("click", function(e){
            e.preventDefault();
